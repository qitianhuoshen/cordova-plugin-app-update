...
public class MsgBox {
     ...
     */
    public Dialog showNoticeDialog(OnClickListener onClickListener,HashMap<String, String> msgMap)
        if (noticeDialog == null) {
            LOG.d(TAG, "showNoticeDialog");
            // 构造对话框
            AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
            builder.setTitle(msgHelper.getString(MsgHelper.UPDATE_TITLE));
            if(msgMap==null||msgMap.get("remark")==null){
              builder.setMessage(msgHelper.getString(MsgHelper.UPDATE_MESSAGE));
            }else{
              String msg= msgMap.get("remark");
              builder.setMessage(msg);
              String forceUpdate=msgMap.get("force");
              if(forceUpdate!=null&&forceUpdate.equals("是")){
                isForceUpdate=true;
              }
            }
            //builder.setMessage(msgHelper.getString(MsgHelper.UPDATE_MESSAGE));
            ...
            if(!isForceUpdate){
              builder.setNegativeButton(msgHelper.getString("update_cancel"),new DialogInterface.OnClickListener(){
                @Override
